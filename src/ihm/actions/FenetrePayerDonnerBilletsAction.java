...
public class FenetrePayerDonnerBilletsAction extends AbstractAction {
	 ...
	 * @see AbstractAction
	 */
	public FenetrePayerDonnerBilletsAction(ListeObjet listeObjet) {
        super("Payer/Donner Billets");
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	if(select) {
	    	try {
				new FenetrePayerDonnerBillets((Personne) listeObjet.getObjetByIndex(selectionCorrige));
			} catch (Exception e1) {
